...
// Register menu
function main_menus() {
	register_nav_menu('header-menu',__( 'Header Menu', 'copywriter-portfolio-theme' ));
}
...
function cpt_entry_footer() {
	...
	$separate_meta = __( ', ', 'copywriter-portfolio-theme' );
			...
			if ( 'post' === get_post_type() ) {
				if (  $categories_list  || $tags_list ) {
					echo '<span class="cat-tags-links">';
						...
						if ( $categories_list  ) {
							echo '<span class="cat-links"><span class="screen-reader-text">' . __( 'Categories', 'copywriter-portfolio-theme' ) . ': </span>' . $categories_list . '</span>';
						}

						if ( $tags_list ) {
							echo '<span class="tags-links"><span class="screen-reader-text">' . __( 'Tags', 'copywriter-portfolio-theme' ) . ': </span>' . $tags_list . '</span>';
						}
